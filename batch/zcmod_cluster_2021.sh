...
#SBATCH --output=data-raw/zcmod/2021/msgs/%a.out
#SBATCH --error=data-raw/zcmod/2021/msgs/%a.err
...
Rscript inst/scripts/cluster_zcmod.R --year=2021 --seed=6262 --nreps=10
